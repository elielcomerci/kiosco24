...
export async function GET(
  ...
  return NextResponse.json({
    ...
    internalCode: inventory.product.internalCode,
    image: inventory.product.image,
    brand: inventory.product.brand,
    description: inventory.product.description,
    presentation: inventory.product.presentation,
    supplierName: inventory.product.supplierName,
    notes: inventory.product.notes,
...
export async function PATCH(
  ...
  await prisma.product.update({
    ...
    data: {
      ...
      ...(internalCode !== undefined && { internalCode: internalCode?.trim() || null }),
